<?php /*a:3:{s:76:"D:\phpStudy\PHPTutorial\WWW\syjk1.0\application\admin\view\product\edit.html";i:1548322365;s:76:"D:\phpStudy\PHPTutorial\WWW\syjk1.0\application\admin\view\public\_meta.html";i:1524812002;s:78:"D:\phpStudy\PHPTutorial\WWW\syjk1.0\application\admin\view\public\_footer.html";i:1535678602;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
    ...
    <div class="page-container">
        <form class="form form-horizontal" id="form-article-add">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" placeholder="商品名称" name="pd_price" value="<?php echo htmlentities($info['pd_price']); ?>" style="width:20%">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>商品库存：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" placeholder="商品库存" name="pd_stock" value="<?php echo htmlentities($info['pd_stock']); ?>" style="width:20%">
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <span class="select-box" style="width:20%">
                        <select name="ca_id"  class="select">
                            <option value="<?php echo htmlentities($info['pd_cate']); ?>">选择商品分类</option>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="number" class="input-text" placeholder="商品销量" name="pd_sale" value="<?php echo htmlentities($info['pd_sale']); ?>" style="width:20%">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">商品描述：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <textarea id="editor" type="text/plain" name="pd_details" style="width:100%;height:400px;"><?php echo $info['pd_details']; ?></textarea>
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <div class="pic" >
                        <!-- <?php if($info['pd_image'] == '0'): ?>
                        <img src="/uploads/shangchuan.png" alt="请上传" class="logo" >
                        <?php else: ?>
                        <img src="<?php echo htmlentities($info['pd_image']); ?>" alt="请上传" class="logo" >
                        <?php endif; ?>
                        ...
                        <?php if(is_array($pd_image) || $pd_image instanceof \think\Collection || $pd_image instanceof \think\Paginator): $i = 0; $__LIST__ = $pd_image;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            ...
            <div class="row cl add" style=" display: flex;justify-content: flex-start;">
                <label class="form-label col-xs-4 col-sm-2">商品类型：</label>
                    <input type="text" class="input-text" placeholder="商品类型" name="type[<?php echo htmlentities($i); ?>]" style="width:20%" value="<?php echo htmlentities($vo['type']); ?>">
                <label class="form-label"><span class="c-red">*</span>商品价格：</label>
                   <input type="text" class="input-text" placeholder="商品价格" name="type_sum[<?php echo htmlentities($i); ?>]" style="width:15%" value="<?php echo htmlentities($vo['type_sum']); ?>">
                <label class="form-label"><span class="c-red">*</span>一代奖励：</label>
                   <input type="text" class="input-text" placeholder="一代奖励" name="gold[<?php echo htmlentities($i); ?>]" style="width:15%" value="<?php echo htmlentities($vo['gold_yd']); ?>">
                <?php if($i == 1): ?>
            ...
            <div style="display:none" class="ttt">
                <?php if(is_array($pd_image) || $pd_image instanceof \think\Collection || $pd_image instanceof \think\Paginator): $i = 0; $__LIST__ = $pd_image;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <input type="text" name="pd_image[]" class="ppp" value="<?php echo htmlentities($vo); ?>">
                <?php endforeach; endif; else: echo "" ;endif; ?>
                <!-- <input type="text" name="pd_image" class="ppp" value="<?php echo htmlentities($info['pd_image']); ?>"> -->
...
function addSku() {
    ...
    var html =
                '<div class="row cl add" style=" display: flex;justify-content: flex-start;">'+
                '<label class="form-label col-xs-4 col-sm-2">商品类型：</label>'+
                    '<input type="text" class="input-text" placeholder="商品类型" name="type['+i+']" style="width:20%">'+
                '<label class="form-label"><span class="c-red">*</span>商品价格：</label>'+
                   '<input type="text" class="input-text" placeholder="商品价格" name="type_sum['+i+']" style="width:15%">'+
                   '<label class="form-label"><span class="c-red">*</span>一代奖励：</label>'+
                   '<input type="text" class="input-text" placeholder="一代奖励" name="gold['+i+']" style="width:15%">'+
                '<button class="btn btn-primary" onclick="return rmSku(this)">移除</button>'+
            '</div>';
    $('#sku').append(html);
    return false;
